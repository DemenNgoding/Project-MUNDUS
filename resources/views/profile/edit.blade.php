...
<body>
    ...
    <form action="/profile/1" method="GET">
        ...
        <input type="text" name="name" value="{!! $user->f_name !!}"><br><br>
        <label for="email"> Email: </label>
        <input type="email" name="email" value="{!! $user->email !!}"><br><br>
        <label for="birthday"> Date of Birth: </label>
        <input type="date" name="birthday" value="{!! $user->birth_date !!}"><br><br>
        ...
        <div class="select-something">
            City:
            <select name="cities" value="{!! $user->city !!}">
        ...
        <!-- To be changed. Placeholder user_id = 1 -->
    <form action="/profile/1/save" method="GET">
